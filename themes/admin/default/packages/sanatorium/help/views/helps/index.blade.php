...
@section('title')
@parent
{{ trans('sanatorium/help::helps/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/help::helps/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/help::helps/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.help.helps.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
								<i class="fa fa-plus"></i> <span class="visible-xs-inline">{{{ trans('action.create') }}}</span>
							</a>
						</li>

						<li>
							<a href="{{ route('admin.sanatorium.help.helps.refresh') }}" data-toggle="tooltip" data-original-title="{{{ trans('sanatorium/help::helps/common.directory_refresh') }}}">
								<i class="fa fa-refresh"></i> <span class="visible-xs-inline">{{{ trans('sanatorium/help::helps/common.directory_refresh') }}}</span>
							</a>
						</li>
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="help" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="help" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="help" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="help" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="help"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.help.helps.grid') }}" data-grid="help">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/help::helps/model.general.id') }}}</th>
					<th class="sortable" data-sort="route">{{{ trans('sanatorium/help::helps/model.general.route') }}}</th>
					<th class="sortable" data-sort="file">{{{ trans('sanatorium/help::helps/model.general.file') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/help::helps/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="help"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/help::helps/grid/index/results')
	@include('sanatorium/help::helps/grid/index/pagination')
	@include('sanatorium/help::helps/grid/index/filters')
	@include('sanatorium/help::helps/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/help::helps/help')
@endif
